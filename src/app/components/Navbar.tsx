...
//   return (
//     <header className='bg-[#011627] top-0 sticky'>
//       <nav className='flex max-w-screen-xl h-[60px] mx-auto text-[#cecfd0] justify-between items-center' >
//         <div className='text-2xl font-semibold px-6 lg:px-0 cursor-pointer border-b-0 hover:border-b-2 hover:border-[#6fffe9] transition-all pb-1.5'>PORTFOLIO <span className='text-[#6fffe9]'>.</span></div>
//         <ul className='hidden lg:flex gap-7 text-sm cursor-pointer'>
//             <li className='border-b-0 hover:border-b-2 hover:border-[#6fffe9] transition-all pb-1.5'>HOME</li>
//             <li className='border-b-0 hover:border-b-2 hover:border-[#6fffe9] transition-all pb-1.5'>ABOUT</li>
//             <li className='border-b-0 hover:border-b-2 hover:border-[#6fffe9] transition-all pb-1.5'>PROJECTS</li>
//             <li className='border-b-0 hover:border-b-2 hover:border-[#6fffe9] transition-all pb-1.5'>CONTACT</li>
//         </ul>
//         <div
...
//         {isOpen && (
//         <ul className="lg:hidden flex flex-col items-center gap-4 bg-[#001d3d] py-4">
//           <li>
//             <Link
//               href="/"
